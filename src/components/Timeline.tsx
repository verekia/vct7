...
export function Timeline() {
  ...
  return (
    <div
      className="timeline-surface flex items-center gap-3 px-3.5 py-1.5 border-t border-line text-[11px] text-muted"
    ...
    >
      ...
      <span className="tabular-nums text-[10px] tracking-[0.5px] uppercase min-w-[80px] text-right">
